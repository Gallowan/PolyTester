...
void PolyTester::printResult(string output, bool pass) const
{
    std::cout << (pass ? "PASS\t" : "FAIL\t")
              << output << std::endl;
}

void PolyTester::testConstructors() const
{
    Polynomial pDefault;
...
void PolyTester::testSizes() const
{
    Polynomial p(4);
...
void PolyTester::testToString() const
{
    Polynomial p(2.1);
...
void PolyTester::testSolve() const
{
    Polynomial p(7);
...
void PolyTester::testBrackets() const
{
    Polynomial p(0);
    p[0] = 4;
...
void PolyTester::testArithmetic() const
{
    Polynomial p1(3);
    Polynomial p2(8);
    Polynomial p3(p1 + p2);
...
void PolyTester::testAssignments() const
{
    double cf1[4] = {2, 1, -4, 9.3};
    double cf2[7] = {3, -1, 18.66, 2, -5, 11, -1};
    Polynomial p1(cf1, 4);
...
void PolyTester::testEquals() const
{
    double cf1[4] = {2, 1, -4, 9.3};
    double cf2[7] = {3, -1, 18.66, 2, -5, 11, -1};
    Polynomial p1(cf1, 4);
